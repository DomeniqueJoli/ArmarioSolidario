...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $email = $_POST['contatoEmail_doador'] ?? '';
    ...
    $doador->contatoEmail_doador = $email;
    $dados = $doador->buscarPorEmail();
    ...
    if (!$dados) {
        ...
        $doador->id_doador = $dados['id_doador'];
        $doador->senhaDoador = $novaSenha;

        if ($doador->atualizarSenha()) {
            $sucesso = true;
  ...
  <div class="container">
    <div class="lado-esquerdo">
      <form class="form" method="POST">
        ...
        <?php endif; ?>
        <input class="ent" type="email" name="contatoEmail_doador" placeholder="Digite seu e-mail" required />
