...
<body>
    ...
    Nome completo: <input type="text" name="nomeDoador" class="nomeD" ><br>
    CPF: <input type="text" name="cpfDoador" class="cpfD" required><br>
    Descrição: <input type="text" name="bioDoador" class="bioD" required><br>
    Data de Nascimento: <input type="date" name="dataDoador" class="dataND" required>
    ...
    Estado: <input type="text" name="estadoDoador" class="estadoD" required>
    Cidade: <input type="text" name="cidadeDoador" class="cidadeD" required><br>
    Bairro: <input type="text" name="bairroDoador" required>
    Rua: <input type="text" name="ruaDoador" class="ruaD" required>
